...
public class AVReceive2 implements ReceiveStreamListener, SessionListener, ControllerListener {
    ...
    public void controllerUpdate(ControllerEvent controllerEvent) {
        Player p = (Player)controllerEvent.getSourceController();
        ...
        if (controllerEvent instanceof ControllerErrorEvent) {
            ...
            System.err.println("AVReceive2 internal error: " + controllerEvent);
        }
    }
    ...
    protected boolean initialize() {
            ...
            for (int i = 0; i < sessions.length; i++) {
                ...
                if( ipAddr.isMulticastAddress()) {
                    ...
                    destAddr = new SessionAddress( ipAddr,
                            session.port,
                            session.ttl);
                    System.out.println(destAddr.getControlHostAddress());
                } else {
        ...
        long waitingPeriod = 100000;  // wait for a maximum of 30 secs.
...
//        if (argv.length == 0)
//            prUsage();
        String dest[]={"192.168.56.1/8888"};
        AVReceive2 avReceive = new AVReceive2(dest);
